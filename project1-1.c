...
const double SS = BASIS;
const double SI = BASIS*k1;
const double SR = BASIS*k2;
const double IS = BASIS*k1;
const double II = BASIS*k1*k1;
const double IR = BASIS*k1*k2;
const double RS = BASIS*k2;
const double RI = BASIS*k1*k2;
const double RR = BASIS*k2*k2;

/*const double SS = BASIS;
const double SI = BASIS*k2;
const double SR = BASIS*k1;
const double IS = BASIS*k2;
const double II = BASIS*k2*k2;
const double IR = BASIS*k1*k2;
const double RS = BASIS*k1;
const double RI = BASIS*k1*k2;
const double RR = BASIS*k1*k1;*/
...
void prints(struct net*, FILE*,int);
...
void prints(struct net *net, FILE* fid, int n)
{
	fprintf(fid, "%g\t%g\t%g\t%g\t%g\t%g\t%u\n", net->layer[0]->S, net->layer[0]->I, net->layer[0]->R, net->layer[1]->S, net->layer[1]->I, net->layer[1]->R, n);
}
